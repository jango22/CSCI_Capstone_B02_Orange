...
<div class="container-sm" id="wrapper">
    ...
    @csrf
        ...
        <input type="text" class="form-control" name="code" id="codeid" placeholder="Code Name" minlength="5" maxlength="15" style="width: 180px;" required> <input type="submit" name="apply" value="Apply Code"><br><br>
