...
<div class="container-sm" id="wrapper">
    ...
    @csrf
        ...
        <input type="text" class="form-control" name="code" id="codeid" placeholder="Code Name" minlength="5" maxlength="15" style="width: 180px;" required> <button type="submit" name="apply">Apply Code</button><br><br>
