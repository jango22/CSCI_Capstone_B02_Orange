		...
		<div class="w3-container">
			...
			<ul id="myUL" class="w3-ul w3-card-4" style="background-color:lightgray">
				...
				<li class="w3-bar w3-hover-green">
					<span onclick="this.parentElement.style.display='none'" class="w3-bar-item w3-button w3-xlarge w3-right">×</span>
					<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQexuifPTPeYz2hKSAbtGBhgU6NSGrQrtbh7w&usqp=CAU" class="thumb w3-bar-item w3-hide-small" style="width:125px; height:125px;">
				...
				<li class="w3-bar w3-hover-yellow">
					...
					<span onclick="this.parentElement.style.display='none'" class="w3-bar-item w3-button w3-xlarge w3-right">×</span>
					<img src="https://www.mccoys.com/images/8ecf916f-26e1-4a1a-9579-535c2d4c5943/400" class="thumb w3-bar-item w3-hide-small" style="width:125px; height:125px;">
					<div class="w3-bar-item">
						<h3>Just a 2x4</h3>
